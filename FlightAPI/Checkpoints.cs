...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity48_checkpoints(STActivityBase activity)
        {
        ...
        private void set_StServiceCallActivity13_checkpoints(STActivityBase activity)
        {
            ...
            BindDirection actualBindDirection1 = new BindDirection(_flow.StServiceCallActivity13, actualValueGetter1, actualValueSetter1);
            CpValObj valueActualObject1 = new CpValObj(actualBindDirection1, XmlTypeCode.Int, false);


            CpValObj valueExpectedObject1 = new CpValObj(bind_dir30);
            ValueCPRule cpRule1 = new ValueCPRule(valueActualObject1, valueExpectedObject1, PrimitiveTypeCP.NotEqualTo, "!=", false);
